...
Yield <- 
  read.table("~/Downloads/IowaCornYieldAnom19502015test.dat", 
...
lonlatSST <- read.table(
  "~/Downloads/lonlatSST.dat", 
  col.names = c("lon", "lat")
)

lonlatTempPrecip <- read.table("~/Downloads/lonlatTempPrecip.dat", 
                               col.names = c("Temp", "Precip"))
Prec <- read.table(
  "~/Downloads/Precip_test_011950_062015.dat",
  col.names = month_index$month)
Temp <- read.table(
  "~/Downloads/Temp_test_011950_062015.dat", 
  col.names = month_index$month
)
SST <- read_table(
  "~/Downloads/SST_test_011950_062015.dat", 
